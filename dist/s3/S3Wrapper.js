...
var S3Wrapper = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.s3
                        ...
                        .promise()
                        .then(function (object) { return object.Body; })
                        .catch(function (error) { return _this.errorWrapper(error, bucket, 'getObject'); })];
            });
        });
    };
    S3Wrapper.prototype.getJson = function (bucket, key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(bucket, key).then(function (body) {
                        if (body) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.s3
                        ...
                        .promise()
                        .catch(function (error) { return _this.errorWrapper(error, bucket, 'putObject'); })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.s3
                        ...
                        .promise()
                        .catch(function (error) { return _this.errorWrapper(error, bucket, 'deleteObject'); })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.s3
                        ...
                        if (result.Contents) {
                            var justKeys = result.Contents.map(function (object) { return object.Key; }).filter(function (key) { return key !== undefined; });
                        ...
                        .catch(function (error) { return _this.errorWrapper(error, bucket, 'listObjectsV2'); })];
            });
        });
    };
