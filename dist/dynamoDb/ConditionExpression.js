...
var ConditionExpression = /** @class */ (function () {
    function ConditionExpression(type, expression, attributes, leftArgumentName) {
        ...
        if (attributes === void 0) { attributes = new ExpressionAttributeHelper(); }
        if (leftArgumentName === void 0) { leftArgumentName = ''; }
        this.type = type;
    ...
    ConditionExpression.prototype.isIn = function (list) {
        ...
        var attributes = this.attributes.copy();
        var left = attributes.addAttributeName(this.leftArgumentName);
        var listPlaceholders = list.map(function (value) { return attributes.addAttributeValue(_this.leftArgumentName, value); });
...
var ExpressionAttributeHelper = /** @class */ (function () {
    function ExpressionAttributeHelper(attributeNames, attributeValues) {
        ...
        Object.keys(attributeNames).forEach(function (key) { return (_this.attributeNames[key] = attributeNames[key]); });
        Object.keys(attributeValues).forEach(function (key) { return (_this.attributeValues[key] = attributeValues[key]); });
    }
    ExpressionAttributeHelper.prototype.addAttributeName = function (name) {
        var keys = name.split('.').map(function (item) { return "#" + item; });
