...
export default class DynamoDbWrapper {
    ...
    query(table: string, keyExpression?: ConditionExpression, conditionExpression?: ConditionExpression, ExclusiveStartKey?: Key, items?: any): any;
    ...
    static cloudFormationForTable: (name: string, primaryKey: {
        name: string;
        type: ScalarAttributeType;
    }, secondaryKey?: {
        name: string;
        type: ScalarAttributeType;
    } | undefined) => CloudFormation;
