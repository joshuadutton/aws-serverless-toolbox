  ...
  SubscriptionHandler.prototype.subscribe = function (thingId, subscriber) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getSubscriptionForThing(thingId)];
          case 1:
  ...
  SubscriptionHandler.prototype.unsubscribe = function (subscriberId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getSubscriberMapForSubscriber(subscriberId)];
          case 1:
          ...
          case 2:
            ...
            subscription.subscribers = subscription.subscribers.splice(
              subscription.subscribers.findIndex(function (subscriber) {
                return subscriber.id === thingId_1;
              }),
              1
            );
          ...
          case 3:
            ...
            return [3 /*break*/, 6];
          case 4:
            return [4 /*yield*/, this.subscriptionStore.put(thingId_1, subscription)];
          case 5:
            _a.sent();
            _a.label = 6;
          case 6:
            return [4 /*yield*/, this.subscriptionStore.delete(subscriberId)];
          case 7:
            _a.sent();
            _a.label = 8;
          case 8:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            subscription = _a.sent();
            if (subscription) {
              promises = subscription.subscribers.map(function (subscriber) {
