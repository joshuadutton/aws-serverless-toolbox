...
var ApiGatewayWebSocketSubscriptions = /** @class */ (function () {
  ...
  ApiGatewayWebSocketSubscriptions.prototype.handler = function (event, context) {
    return __awaiter(this, void 0, void 0, function () {
      var connectionId, routeKey, domain, stage, headers, endpoint, userId, _a, subscriber, error_1;
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            _b.trys.push([1, 9, , 11]);
            return [4 /*yield*/, this.auth.verifyBearerToken(headers['Authorization'], ['self'])];
          case 2:
            userId = _b.sent();
          ...
          case 3:
            ...
            return [4 /*yield*/, this.subscriptionHandler.subscribe(userId, subscriber)];
          case 4:
            _b.sent();
            return [3 /*break*/, 8];
          case 5:
            return [4 /*yield*/, this.subscriptionHandler.unsubscribe(connectionId)];
          case 6:
            _b.sent();
            return [3 /*break*/, 8];
          case 7:
