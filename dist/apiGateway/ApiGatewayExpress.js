...
var ApiGatewayExpress = /** @class */ (function () {
    ...
    ApiGatewayExpress.prototype.attachUserAuthMiddleware = function (request, response, next) {
        var _a, _b, _c, _d;
        var principalId = (_d = (_c = (_b = (_a = request.apiGateway) === null || _a === void 0 ? void 0 : _a.event) === null || _b === void 0 ? void 0 : _b.requestContext) === null || _c === void 0 ? void 0 : _c.authorizer) === null || _d === void 0 ? void 0 : _d.principalId;
        if (principalId) {
