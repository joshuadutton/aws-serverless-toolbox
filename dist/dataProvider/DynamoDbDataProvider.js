...
var DynamoDbDataProvider = /** @class */ (function () {
    ...
    DynamoDbDataProvider.prototype.getList = function (resource, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryOrScan(resource, options.filter)];
                    case 1:
                        items = _a.sent();
                        if (options.sort) {
    ...
    DynamoDbDataProvider.prototype.get = function (resource, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.get(this.tableForResource(resource), this.keyForResource(resource, id))];
                    case 1:
                        item = _a.sent();
    ...
    DynamoDbDataProvider.prototype.getMany = function (resource, ids) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.batchGet(this.tableForResource(resource), ids.map(function (id) { return _this.keyForResource(resource, id); }))];
                    case 1:
                        items = _a.sent();
                        return [2 /*return*/, {
                                data: items,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tableName = this.tableForResource(resource);
                        return [4 /*yield*/, this.db.batchGet(tableName, items.map(function (item) { return _this.keyForResource(resource, item.id); }))];
                    case 1:
                        originals = _a.sent();
    ...
    DynamoDbDataProvider.prototype.delete = function (resource, id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.delete(this.tableForResource(resource), this.keyForResource(resource, id))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, {
                                data: id
    ...
    DynamoDbDataProvider.prototype.deleteMany = function (resource, ids) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        keys = ids.map(function (id) { return _this.keyForResource(resource, id); });
