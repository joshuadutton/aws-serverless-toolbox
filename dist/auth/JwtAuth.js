...
var JwtAuth = /** @class */ (function () {
    function JwtAuth(store, timeToLive, revokable) {
        if (timeToLive === void 0) { timeToLive = 3600; }
        if (revokable === void 0) { revokable = false; }
        this.hashLength = 256;
        this.digest = 'sha256';
        this.saltLength = 64;
    ...
    JwtAuth.prototype.createToken = function (id, scopes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getSigningSecret()];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4: return [2 /*return*/, decoded.sub];
                    case 5:
                        error_1 = _a.sent();
    ...
    JwtAuth.prototype.addPassword = function (id, password, scopes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.passwordStore.get(id)];
                    case 1:
                        if (_a.sent()) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        error_2 = _a.sent();
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/, Promise.reject('revocation unsuccessful')];
                }
            });
        });
    };
